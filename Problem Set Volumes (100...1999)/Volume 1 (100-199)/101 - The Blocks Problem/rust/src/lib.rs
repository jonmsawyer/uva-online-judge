...
impl Blocks {
    ...
    /// to `Move` and sets the `a` parameter appropriately. If the
    ...
    fn parameters_invalid(&self) -> bool {
        ...
        {
            println!("parameters_invalid = true");
            
            true
        }
        else {
            let same_stack = self.same_stack();
            
            if same_stack {
                println!("parameters_invalid = true");
                println!("same_stack = true");
            }
...
mod test {
    ...
    fn blocks_call_multiple_move_a() {
        ...
        // Call first move_a() method, new state should be BlockState::Move.
        blocks.move_a(3);
        assert_eq!(blocks.a, Some(3));
        assert_eq!(blocks.b, None);
        assert_eq!(blocks.state, BlockState::Move);
        
        // Call second move_a() method (when state is already BlockState::Move).
        blocks.move_a(5);
        assert_eq!(blocks.a, None);
        assert_eq!(blocks.b, None);
        assert_eq!(blocks.state, BlockState::Init);
        
        // Call third move_a() method (when state is BlockState::Init).
        blocks.move_a(7);
    ...
    fn blocks_call_multiple_pile_a() {
        ...
        // Call first pile_a() method, new state should be BlockState::Pile.
        blocks.pile_a(3);
        assert_eq!(blocks.a, Some(3));
        assert_eq!(blocks.b, None);
        assert_eq!(blocks.state, BlockState::Pile);
        
        // Call second pile_a() method (when state is already BlockState::Pile).
        blocks.pile_a(5);
        assert_eq!(blocks.a, None);
        assert_eq!(blocks.b, None);
        assert_eq!(blocks.state, BlockState::Init);
    ...
    fn blocks_chain_move_a() {
        ...
        // Chain 2 move_a() methods. Final state should be BlockState::Init.
        blocks.move_a(3).move_a(5);
        assert_eq!(blocks.a, None);
        assert_eq!(blocks.b, None);
        assert_eq!(blocks.state, BlockState::Init);
        
        // Chain 3 move_a() methods. Final state should be BlockState::Move.
        blocks.move_a(3).move_a(5).move_a(7);
        assert_eq!(blocks.a, Some(7));
        assert_eq!(blocks.b, None);
        assert_eq!(blocks.state, BlockState::Move);
        
        // Call third set of move_a() methods. Final state should be BlockState::Init.
        blocks.move_a(5);
        assert_eq!(blocks.a, None);
        assert_eq!(blocks.b, None);
        assert_eq!(blocks.state, BlockState::Init);
    ...
    fn blocks_chain_pile_a() {
        ...
        // Chain 2 pile_a() methods. Final state should be BlockState::Init.
        blocks.pile_a(3).pile_a(5);
        assert_eq!(blocks.a, None);
        assert_eq!(blocks.b, None);
        assert_eq!(blocks.state, BlockState::Init);
        
        // Chain 3 pile_a() methods. Final state should be BlockState::Pile.
        blocks.pile_a(3).pile_a(5).pile_a(7);
        assert_eq!(blocks.a, Some(7));
        assert_eq!(blocks.b, None);
        assert_eq!(blocks.state, BlockState::Pile);
        
        // Call third set of pile_a() methods. Final state should be BlockState::Init.
        blocks.pile_a(5);
        assert_eq!(blocks.a, None);
        assert_eq!(blocks.b, None);
        assert_eq!(blocks.state, BlockState::Init);
    ...
    fn blocks_mix_and_match_move_a_and_pile_a() {
        ...
        blocks.move_a(2); // Final state should be BlockState::Init.
